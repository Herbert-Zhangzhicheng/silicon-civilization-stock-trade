...
机柜供电链（功率半导体、MLCC/被动元件、AIDC供配电、备用电源/燃机）、
IDC、HBM/存储、半导体设备与材料、高速 PCB/CCL、晶圆代工、云。
...
- 子主题命名沿用当前列表（算力/AI芯片、光模块、AI服务器、液冷、IDC、功率半导体、MLCC/被动元件、AIDC供配电、备用电源/燃机、存储/HBM、半导体设备、半导体材料、AI-PCB、晶圆代工、云/AI基建）。
- 电域优先选择直接进入 AIDC 供电连续性链路的设备和器件公司，剔除纯发电运营商（传统火电、水电、风光、核电运营商）。
